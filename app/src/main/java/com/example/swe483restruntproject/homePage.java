...
public class homePage extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(c!=null)
            while(c.moveToNext()){
                restlist.add(new restuntsHomePageListItemModel(null,c.getString(1), c.getString(3), 4));
            }//change the null inside the loop

        getSupportFragmentManager().beginTransaction().replace(R.id.fragmentContainerView22, new restListFragment(restlist) ).commit();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arabicSort.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment s = new restListFragment(restlist);
